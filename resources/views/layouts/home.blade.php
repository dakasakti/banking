            ...
            >
                ...
                >
                    ...
                    <a
                        ...
                        class="block px-4 py-3 mt-10 text-lg font-bold text-gray-800 uppercase bg-white rounded-lg hover:bg-gray-500"
                    >
                        Dashboard
                    </a>
                    @else
                    <div class="flex">
                        <a
                            href="{{ route('login') }}"
                            class="block px-4 py-3 mt-5 mr-2 text-lg font-bold text-gray-800 uppercase bg-white rounded-lg hover:bg-gray-100"
                        >
                            Login
                        </a>
                        <a
                            href="{{ route('register') }}"
                            class="block px-4 py-3 mt-5 text-lg font-bold text-gray-800 uppercase bg-white rounded-lg hover:bg-gray-100"
                        >
                            Register
                        </a>
                    </div>
