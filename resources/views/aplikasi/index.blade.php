...
<div class="container relative left-0 z-50 flex w-3/4 h-auto">
    <a href="{{ route('admin.create') }}"><button class="px-4 py-2 text-center text-white bg-gray-500 border rounded-lg hover:bg-green-500">Tambah Data</button></a>
</div>
...
<table class="min-w-full">
    ...
    <tbody>
      ...
      <tr class="border-b odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700 dark:border-gray-600">
        ...
        <td class="px-6 py-4 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-gray-400">
            {{ $data->email }}
            </td>
        <td>
          <ul class="lg:flex">
            <li class="my-2 lg:mr-2">
              <a href="{{ route('admin.show', $data->invoice) }}"><button class="block text-white bg-green-500 hover:bg-gray-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                Detail
              </button></a>
            </li>
            <li class="my-2 lg:mr-2">
              <a href="{{ route('admin.edit', $data->invoice) }}"><button class="block text-white bg-blue-700 hover:bg-gray-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                Edit
              </button></a>
            </li>
            <li class="my-2 mr-2">
            <form action="{{ route('admin.destroy', $data->invoice) }}" method="POST">
              @csrf
              @method('delete')
